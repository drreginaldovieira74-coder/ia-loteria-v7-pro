...
st.markdown("**Ciclo como ideia central • v45.2 (Versão Estável)**")
...
with tab1:
    ...
    st.info("Clique no botão abaixo para gerar jogos")
...
st.caption("LOTOELITE PRO v45.2 – Todas as 7 abas devem abrir agora")
